...
\STANDARD{Adafruit Industries (2024):}
{
...
\STANDARD{Adafruit Industries (2024)b:}
{
	\begin{minipage}{0.38\textwidth}
...
\STANDARD{JOY-IT (2019):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. Schrittmotor Datenblatt.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/A300/NEMA17-04ß\_DN\_DE.pdf, zuletzt aktualisiert 2019, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von JOY-IT zum Schrittmotor
	\end{minipage}
	\textbf{Schlagwörter:}
	Schrittmotor, NEMA17
	\\ \textbf{Bewertung:}
	Hilfreiche Informationen zu den Spezifikationen des Schrittmotors.
}
...
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. Drehschalter Datenblatt.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/C200/DS-Serie~LOR.pdf, zuletzt aktualisiert 2025, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Lorlin zum Drehschalter
	\end{minipage}
	\textbf{Schlagwörter:}
	Drehschalter, Stufen-Drehschalter
	\\ \textbf{Bewertung:}
	Hilfreiche Informationen zu den Spezifikationen des Drehschalters, wurde aber am Ende nicht benutzt und durch einen Encoder ersetzt.
}
...
\STANDARD{Panasonic Electric Works Co. (2025):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. Datenblatt Mikroschalter.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/C200/AVX3\_DB\_EN.pdf, zuletzt aktualisiert 2025, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Panasonic zum verwendeten Mikroschalter
	\end{minipage}
	\textbf{Schlagwörter:}
	Mikroschalter
...
\STANDARD{RAFI GmbH \& Co. KG (2025):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. Datenblatt Drucktaster.
		Online verfügbar unter https://ecatalog.rafi-group.com/DE/DE/1151063010104.pdf, zuletzt aktualisiert 2025, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von RAFI zum verwendeten Drucktaster
	\end{minipage}
	\textbf{Schlagwörter:}
	Drucktaster
...
\STANDARD{Rainer Parthier (2020):}
{

	\begin{minipage}{1\textwidth}
		Buch (Monographie). Messtechnik - Vom SI-Einheitensystem über Bewertung von Messergebnissen zu Anwendungen der elektrischen Messtechnik. Mittweida: Springer Vieweg Wiesbaden.	
		\\ \textbf{Kurzfassung:}
		Dieses Lehr- und Übungsbuch erläutert anschaulich Prinzipien und moderne Verfahren der elektrischen Messtechnik. Es hilft direkt messtechnische Fragestellungen richtig einzuschätzen. Kontrollfragen und Übungsaufgaben ermöglichen eine selbstständige Lernkontrolle und damit ein erfolgreiches Selbststudium.
	\end{minipage}
	\textbf{Schlagwörter:}
	Messtechnik; Sensoren
	\\ \textbf{Bewertung:}
	Dieses Buch wurde als Quelle für die Beschreibung des Geschwindigkeitssensors verwendet. Die Ausführungen sind sehr Ausführlich, ergänzte somit gut die restliche Literatur zum Sensor.
	\\ \textbf{ISBN:}
	978-3-658-27131-2
}
...
\STANDARD{Reichelt:}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. Drehschalter Datenblatt.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/C200/DS\_serie~CUK.pdf, zuletzt aktualisiert 2025, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Reichelt zum Drehschalter
	\end{minipage}
	\textbf{Schlagwörter:}
	Drehschalter, Stufen-Drehschalter
	\\ \textbf{Bewertung:}
...
\STANDARD{Silvio Goetel (2025):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. Präsentation zu OLED Display.
		Online verfügbar unter https://tu-dresden.de/ing/informatik/ti/vlsi/ressourcen/dateien/dateien\_studium/dateien\_lehstuhlseminar/vortraege\_lehrstuhlseminar/folder-2010-04-30-7782863372/OLED\_Vortrag.pdf, zuletzt aktualisiert 2025, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Präsentation der TU Dresden zum Thema OLED-Displays
	\end{minipage}
	\textbf{Schlagwörter:}
	OLED; OLED-Display; Display
	\\ \textbf{Bewertung:}
	Hilfreiche Informationen zur Funktion eines OLED-Displays.
}
...
\STANDARD{Simac Electronics GmbH (2020):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. LM393-Datasheet.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/A300/DATASHEET-SEN-SPEED.pdf, zuletzt aktualisiert 2020, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Simac Electronics zum Geschwindigkeitssensor LM393
	\end{minipage}
	\textbf{Schlagwörter:}
	Geschwindigkeitssensor; LM393
	\\ \textbf{Bewertung:}
	Biete alle wichtigen Spezifikationen zum Geschwindigkeitssensor.
}

\STANDARD{Simac Electronics GmbH (2021):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. OLED-Display Datenblatt.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/A300/COM-OLED2.42\_DATENBLATT\_2021-03-11.pdf, zuletzt aktualisiert 2021, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Simac Electronics zum OLED-Display
	\end{minipage}
	\textbf{Schlagwörter:}
	OLED; OLED-Display; Display
	\\ \textbf{Bewertung:}
	Hilfreiche Informationen zu den Spezifikationen des Displays.
}

\STANDARD{Simac Electronics GmbH (2021):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. OLED-Display Anleitung.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/A300/COM-OLED2.42\_ANLEITUNG\_2021-02-05.pdf, zuletzt aktualisiert 2021, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Anleitung von Simac Electronics zum Geschwindigkeitssensor LM393
	\end{minipage}
	\textbf{Schlagwörter:}
	OLED; OLED-Display; Display
	\\ \textbf{Bewertung:}
	Hilfreiche Informationen zum Anschluss und zur Programmierung des Displays.
}

\STANDARD{Simac Electronics GmbH (2024):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. LM393 Anleitung.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/A300/SEN-SPEED-ANLEITUNG-20201015.pdf, zuletzt aktualisiert 2024, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Anleitung von Simac Electronics zum Geschwindigkeitssensor LM393
	\end{minipage}
	\textbf{Schlagwörter:}
	Geschwindigkeitssensor; LM393
	\\ \textbf{Bewertung:}
	Hilfreiche Informationen zum Anschluss und zur Programmierung des Geschwindigkeitssensors.
}
...
\STANDARD{Texas Instruments Incorporated (2011):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. DRV8825-Datasheet.
		Online verfügbar unter https://cdn-reichelt.de/documents/datenblatt/A300/SOLDERED\_DRV8825\_DATASHEET.pdf, zuletzt aktualisiert 2011, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Texas Instruments zum Schrittmotortreiber DRV8825
	\end{minipage}
	\textbf{Schlagwörter:}
	Schrittmotortreiber; Treiber; DRV8825
	\\ \textbf{Bewertung:}
	Viele hilfreiche Informationen, aber sehr viel und an mancher Stelle schwer zu verstehen.
}

\STANDARD{Texas Instruments Incorporated (2014):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. DRV8825-Datasheet.
		Online verfügbar unter https://www.ti.com/de/lit/gpn/drv8825, zuletzt aktualisiert 2014, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Texas Instruments zum Schrittmotortreiber DRV8825
	\end{minipage}
	\textbf{Schlagwörter:}
...
\STANDARD{Texas Instruments Incorporated (2025):}
{
	\begin{minipage}{1\textwidth}
		Internetdokumentation. LM393-Datasheet.
		Online verfügbar unter https://www.ti.com/lit/gpn/lm393, zuletzt aktualisiert 2025, zuletzt geprüft am 12.07.2025.
		\\ \textbf{Kurzfassung:}
		Datenblatt von Texas Instruments zum Geschwindigkeitssensor LM393
	\end{minipage}
	\textbf{Schlagwörter:}
	Geschwindigkeitssensor; LM393
	\\ \textbf{Bewertung:}
