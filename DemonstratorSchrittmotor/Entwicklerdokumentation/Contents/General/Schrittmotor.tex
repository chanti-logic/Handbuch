...
\begin{figure}[H]
	\begin{center}
		\include{tikz/AufbauSchrittmotor}
...
Der NEMA 17 Schrittmotor findet vor allem in 3D-Druckern, CNC-Fräsen, Kameraschlitten oder Robotikachsen Anwendung. \cite{NEMA17}

\section{Spezifikation}

In Tabelle \autoref{tab:SpezifikationNEMA17} sind die Spezifikationen des NEMA 17 aufgelistet. 
...
\begin{table}[htpb]
	...
	\begin{tabular}{|l|c|}
		...
		Phaseninduktivität & 5 mH \\s
		Isolationswiderstand & 500 V DC \\
		Isolationsklasse & B (130°) \\
		Trägheitsmoment & $57\,\mathrm{g\cdot cm^2}$ \\
		Rastmoment & 0,015 Nm \\
		zuläss. Temperaturbereich & -10 °C bis 50 °C \\
		\hline
	\end{tabular}
	\caption{Spezifikationen des NEMA 17 Schrittmotors \cite{NEMA17}}
	\label{tab:SpezifikationNEMA17}
\end{table}
