...
% $Autor: Wings $
% $Datum: 2020-10-12 $
% $Pfad: DemonstratorSchrittmotor\DeleoperDoc\General\acronyms.tex $
% $Version: 1 $
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\DeclareAcronym{aar}{
	short = AAR\index{AAR}, 
	long  = Automatic Address Recognition\index{Automatic Address Recognition!\Siehe AAR},
}
...
\DeclareAcronym{aes}{
	short = AES\index{AES}, 
	long  = Advanced Encryption Standard\index{Advanced Encryption Standard!\Siehe AES},
}
\DeclareAcronym{ap}{
	short = AP\index{AP}, 
...
\DeclareAcronym{ble}{
	short = BLE\index{BLE}, 
	long  = Bluetooth Low Energie\index{Bluetooth Low Energie!\Siehe {BLE}},
}
...
\DeclareAcronym{cad}{
	short = CAD\index{CCI},
	long  = Computer Aided Design\index{Computer Aided Design!\Siehe {CCI}},
}
...
\DeclareAcronym{ccm}{
	short = CCM\index{CCM},
	long  = Counter with CBC-MAC\index{Counter with CBC-MAC!\Siehe{CCM}},
}
...
\DeclareAcronym{dma}{
	short = DMA\index{DMA}, 
	long  = Direkt Memory Access\index{Direkt Memory Access!\Siehe DMA},
}
...
\DeclareAcronym{hy}{
	short = hy\index{HDMI},
	long  = Hybrid\index{Hybrid!\Siehe {HDMI}},
}
...
\DeclareAcronym{ic}{
	short = IC\index{IC},
	long  = Inter Circuit\index{Inter Circuit!\Siehe IC},
}
...
\DeclareAcronym{nfc}{
	short = NFC\index{NFC},
	long  = Near Field Communication\index{Near Field Communication!\Siehe {NFC}} ,
}
...
\DeclareAcronym{pdm}{
	short = PDM\index{PDM} ,
	long  = Pulsdichtenmodulation\index{Pulsdichtenmodulation!\Siehe PDM} ,
}
...
\DeclareAcronym{smd}{
	short = SMD\index{SMD} ,
	long  = Surface Mount Device\index{Surface Mount Device!\Siehe SMD} ,
}
...
\DeclareAcronym{soc}{
short = SoC\index{SoC} ,
long  = System on Chip\index{System on Chip!\Siehe SoC} ,
}
...
\DeclareAcronym{musb}{
	short = Micro USB\index{Micro USB},
	long = Micro Universal Serial Bus\index{Micro Universal Serial Bus!\Siehe {Micro USB}},
}

\DeclareAcronym{uv}{
	short = UV-Filter\index{Micro USB},
	long = Ultravioletter-Filter\index{Ultravioletter-Filter!\Siehe {Micro USB}},
}
