...
Zur Befestigung der Lochscheibe wird die Lochscheibe mithilfe einer Unterlegscheibe und Mutter auf der Schraube handfest angezogen. Dies ist in Abbildung \ref{} dargestellt.
	...
	\begin{tikzpicture}[scale=0.6]
			...
			\node [font=\Huge] at (28.75,-15.25) {3};
			\node [font=\Huge] at (36,-15) {2};
			\node [font=\Huge] at (44.75,-15) {1};
			\node [font=\Huge] at (19.25,-15) {4};
		\end{circuitikz}
	}%
